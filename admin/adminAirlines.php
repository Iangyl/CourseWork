...
<body>
    <div id="container">
        ...
        <article id="airlines-block">
            ...
            <form name="add_a" action="../php/insert/insertAirlines.php" method="post" class="form-insert">
            ...
            <?php
                ...
                while($row = $result->fetch(PDO::FETCH_LAZY))
                {
                    echo "
                    <tr>
                    <form action='../php/change/changeAirlines.php' method='post'>
                        <td>{$row['ID']}</td>
                    ...
                    <td>"
                    ?>
                        <form action='../php/delete/deleteAirlines.php' method='post'>
                            <input type="hidden" name="id" value="<? echo $row['ID'];?>">
