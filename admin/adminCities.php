...
<body>
    <div id="container">
        ...
        <article id="cities-block" class="block">
            ...
            <form name="add_bp" action="../php/insert/insertCities.php" method="post" class="form-insert">
            ...
            <?php
                ...
                {
                    echo "
                    <tr><form action='../php/change/changeCities.php' method='post'>
                    <td>{$row['ID']}</td>
                    ...
                    <td>"
                    ?>
                        <form action='../php/delete/deleteCities.php' method='post'>
                            <input type="hidden" name="id" value="<? echo $row['ID'];?>">
