...
<body>
    <div id="container">
        ...
        <article id="cities-block" class="block">
            ...
            <form name="add_bp" action="../php/insert/insertCitiesSecond.php" method="post" class="form-insert">
            ...
            <?php
                ...
                {
                    echo "
                    <tr><form action='../php/change/changeCitiesSecond.php' method='post'>
                    <td>{$row['ID']}</td>
                    ...
                    <td>"
                    ?>
                        <form action='../php/delete/deleteCitiesSecond.php' method='post'>
                            <input type="hidden" name="id" value="<? echo $row['ID'];?>">
