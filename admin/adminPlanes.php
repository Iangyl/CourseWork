...
<body>
    <div id="container" style="overflow: visible;">
        ...
        <article id="planes-block" class="block">
            ...
            <form name="add_d" action="../php/insert/insertPlanes.php" method="post" class="form-insert">
            ...
            <?php
                ...
                {
                    echo "
                    <tr><form action='../php/change/changePlanes.php' method='post'>
                    <td>{$row['ID']}</td>
                    ...
                    <td>"
                    ?>
                       <form action='../php/delete/deletePlanes.php' method='post'>
                            <input type="hidden" name="id" value="<? echo $row['ID'];?>">
